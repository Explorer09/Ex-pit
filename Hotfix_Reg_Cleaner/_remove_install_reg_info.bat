...
ECHO Last updated: 2013-08-14 (August 2013 Patch Tuesday)
ECHO.
...
SET ie8_update_list=
FOR %%i in (
KB2510531-IE8 KB2598845-IE8 KB2632503-IE8 KB2862772-IE8
) DO (
...
KB2838727-IE8 KB2846071-IE8 KB2847204-IE8
) DO (

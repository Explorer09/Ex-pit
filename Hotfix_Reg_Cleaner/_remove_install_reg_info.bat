...
ECHO Last updated: 2014-02-12 (February 2014 Patch Tuesday)
ECHO.
...
SET ie8_update_list=
FOR %%i in (
KB2510531-IE8 KB2598845-IE8 KB2632503-IE8 KB2909210-IE8 KB2909921-IE8
) DO (
...
KB2879017-IE8 KB2888505-IE8 KB2898785-IE8
) DO (

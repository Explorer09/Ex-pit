...
ECHO Last updated: 2013-02-13 (Feburary 2013 Patch Tuesday)
ECHO.
...
SET ie8_update_list=
FOR %%i in (
KB2510531-IE8 KB2598845-IE8 KB2632503-IE8 KB2792100-IE8 KB2797052-IE8
) DO (
...
KB2699988-IE8 KB2722913-IE8 KB2744842-IE8 KB2761465-IE8 KB2799329-IE8
) DO (
